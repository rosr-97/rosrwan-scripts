// ==UserScript==
// @name         Autoplay Control on Playlists
// @namespace    minawan
// @version      2026-02-12
// @description  Brings back the autoplay button into playlists.
// @author       rosrwan
...
(function() {
  ...
  const ytdObserver = new MutationObserver((mutationsList, observer) => {
    ...
    interval = setInterval(() => {
      ...
      ytdPlayer.querySelector('.html5-video-player')?.classList.add('ytp-fullscreen-grid-active', 'ended-mode');
      ytdPlayer.querySelector('.html5-video-player')?.classList.remove('paused-mode');
